...
function createStaticHandler(routes, opts) {
	...
	async function query(request, { requestContext, filterMatchesToLoad, skipLoaderErrorBubbling, skipRevalidation, dataStrategy, unstable_stream: stream, unstable_respond: respond } = {}) {
		...
		if (!isValidMethod(method) && method !== "HEAD") {
			...
			return respondOrStreamStaticContext({
				basename,
				location,
			...
			try {
				...
				let response = await runMiddlewarePipeline({
					...
					if (renderedStaticContext) {
						...
						return respondOrStreamStaticContext(getStaticContextFromError(dataRoutes, renderedStaticContext, error, skipLoaderErrorBubbling ? routeId : findNearestBoundary(matches, routeId).route.id));
					} else return respondOrStreamStaticContext({
						matches,
						location,
						basename,
						loaderData: {},
