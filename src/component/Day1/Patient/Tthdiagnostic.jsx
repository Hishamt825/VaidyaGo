...
const Tthdiagnostic = ({ onClose }) => {
  const navigate = useNavigate();
  const [showSaved, setShowSaved] = useState(false);

  return (
    <React.Fragment>
      <div className="tth-diagnostic-container" onClick={onClose}>
        <div className="tth-card" onClick={(e) => e.stopPropagation()}>
          <button className="tth-close-btn" onClick={onClose || (() => navigate(-1))}>
            <Icon name="close" />
          </button>
          ...
          <footer className="tth-footer">
            ...
            <div className="tth-actions">
              ...
              <button className="tth-btn tth-btn-solid" onClick={() => setShowSaved(true)}>Save to My Record</button>
            </div>
          </footer>
        </div>
      </div>
