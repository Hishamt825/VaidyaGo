...
const patientsData = [
  { id: 1, name: 'Saumya tiwari', age: 22, gender: 'Female', date: '15-feb-2026', status: 'CONFIRMED', img: img1 },
  { id: 2, name: 'Saumya', age: 27, gender: 'Female', date: '14-feb-2026', status: 'CANCELLED', img: img2 },
  { id: 3, name: 'Mr. Sardar Singh', age: 21, gender: 'Male', date: '14-feb-2026', status: 'Pending', img: img3 },
  { id: 4, name: 'Saumya tiwari', age: 22, gender: 'Female', date: '15-feb-2026', status: 'CONFIRMED', img: img1 },
  { id: 5, name: 'Mr. Sardar Singh', age: 21, gender: 'Male', date: '14-feb-2026', status: 'Pending', img: img3 },
  { id: 6, name: 'Saumya', age: 27, gender: 'Female', date: '14-feb-2026', status: 'CANCELLED', img: img2 },
  { id: 7, name: 'Mr. Sardar Singh', age: 21, gender: 'Male', date: '14-feb-2026', status: 'Pending', img: img3 },
  { id: 8, name: 'Saumya tiwari', age: 22, gender: 'Female', date: '15-feb-2026', status: 'CONFIRMED', img: img1 },
  { id: 9, name: 'Saumya tiwari', age: 22, gender: 'Female', date: '15-feb-2026', status: 'CONFIRMED', img: img1 },
  { id: 10, name: 'Saumya tiwari', age: 22, gender: 'Female', date: '15-feb-2026', status: 'CONFIRMED', img: img1 },
  { id: 11, name: 'Saumya', age: 27, gender: 'Female', date: '14-feb-2026', status: 'CANCELLED', img: img2 },
  { id: 12, name: 'Mr. Sardar Singh', age: 21, gender: 'Male', date: '14-feb-2026', status: 'Pending', img: img3 },
  { id: 13, name: 'Saumya tiwari', age: 22, gender: 'Female', date: '15-feb-2026', status: 'CONFIRMED', img: img1 },
  { id: 14, name: 'Mr. Sardar Singh', age: 21, gender: 'Male', date: '14-feb-2026', status: 'Pending', img: img3 },
  { id: 15, name: 'Saumya', age: 27, gender: 'Female', date: '14-feb-2026', status: 'CANCELLED', img: img2 },
  { id: 16, name: 'Mr. Sardar Singh', age: 21, gender: 'Male', date: '14-feb-2026', status: 'Pending', img: img3 },
  { id: 17, name: 'Saumya tiwari', age: 22, gender: 'Female', date: '15-feb-2026', status: 'CONFIRMED', img: img1 },
  { id: 18, name: 'Saumya tiwari', age: 22, gender: 'Female', date: '15-feb-2026', status: 'CONFIRMED', img: img1 }
];
...
const Appointmentb = () => {
  ...
  return (
    <div className="flex h-screen w-full bg-[#f4f7fa] font-sans text-sm overflow-hidden text-gray-700">
      ...
      {/* Sidebar */}
      <aside className="w-[190px] flex-shrink-0 flex flex-col bg-[#f4f7fa] shadow-[2px_0_5px_rgba(0,0,0,0.02)] z-10">
        <div className="h-[74px] flex items-center mt-2 relative z-20 w-full pl-[22px]">
          <div className="w-[145px] h-full flex items-center justify-center border-r-[1.5px] border-[#398499] border-t-[1.5px] bg-white rounded-tr-[18px] relative">
            <img src={logoUrl} alt="VADYAGO Logo" className="h-[36px] w-auto object-contain mr-[6px] mt-[4px]" />
          </div>
        </div>

        <div className="relative w-full shrink-0">
          <div className="absolute left-[22px] top-[10px] h-[198px] w-[42px] border-[1.5px] border-[#398499] rounded-full pointer-events-none z-0"></div>
          
          <div 
            className="absolute left-[20px] right-[10px] h-[50px] bg-[#147b93] rounded-l-full rounded-r-[16px] shadow-[0_2px_8px_rgba(20,123,147,0.4)] z-10 transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]"
          ...
          <nav className="flex flex-col relative z-20 w-full pl-[22px] pr-[18px] py-[10px]">
        ...
        <div className="flex-1 w-full pl-[22px] relative z-20">
           <div className="w-[145px] h-full bg-white border-r-[1.5px] border-[#398499]"></div>
        </div>
      </aside>
      ...
      <main className="flex-1 flex flex-col bg-white overflow-hidden">
        ...
        <header className="h-[74px] flex flex-row items-center justify-between px-8 shrink-0 bg-white">
          <div className="flex items-center flex-1 max-w-[700px] gap-[12px]">
            ...
            <div className="relative flex-1">
              ...
              <input type="text" placeholder="Search" className="w-full pl-[40px] pr-4 py-[9px] bg-white border border-gray-600 rounded-full text-[13.5px] text-gray-700 outline-none focus:border-[#468e9f]" />
            </div>
          </div>
        ...
        <div className="flex-1 overflow-auto p-4 px-[26px] bg-white min-h-0 relative">

            {/* Top Date Nav */}
            <div className="flex items-center gap-[10px] mb-5 pl-1">
               <button onClick={handlePrevDate} className="w-[28px] h-[28px] rounded-full bg-[#e2e8f0] flex items-center justify-center text-gray-500 hover:bg-gray-300 transition-colors">
               ...
               <button onClick={handleNextDate} className="w-[28px] h-[28px] rounded-full bg-[#e2e8f0] flex items-center justify-center text-gray-500 hover:bg-gray-300 transition-colors">
            ...
            {/* Tabs Row */}
            <div className="bg-white border border-gray-600 rounded-full h-[46px] flex items-center px-[5px] justify-between mb-[22px] shadow-[0_2px_10px_rgba(0,0,0,0.03)] w-full">
               <div className="relative flex items-center h-full gap-[24px] px-[8px]">
                  {/* Animated Background */}
                  <div 
                    className="absolute h-[34px] bg-[#339eb3] rounded-full transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]"
            ...
            {/* Cards Grid */}
            <div className="grid grid-cols-3 gap-x-[24px] gap-y-[24px] w-full pb-8">
               {patientsData.map((p, index) => {
                 let borderColorClass = '';
                 let btnColorClass = '';
                 
                 if (p.status === 'CONFIRMED') {
                   borderColorClass = 'border-[#22c55e]'; // Green
                   btnColorClass = 'bg-[#22c55e] hover:bg-[#1faa51] text-white';
                 } else if (p.status === 'CANCELLED') {
                   borderColorClass = 'border-[#ef4444]'; // Red
                   btnColorClass = 'bg-[#ef4444] hover:bg-[#dd3b3b] text-white';
                 } else { // Pending
                   borderColorClass = 'border-[#6366f1]'; // Blue
                   btnColorClass = 'bg-[#eab308] hover:bg-[#ca9e05] text-white'; // Yellow button
                 }

                 return (
                   <div key={index} className={`bg-white rounded-[6px] border-[1.5px] flex flex-col overflow-hidden transition-shadow ${borderColorClass}`}>
                      
                      {/* Avatar */}
                      <div className="flex justify-center pt-[22px] pb-[16px]">
                         <div className={`w-[95px] h-[95px] rounded-full p-[3px] border-[2px] ${borderColorClass}`}>
                      ...
                      {/* Info Details */}
                      <div className="px-[18px] pb-[18px] flex flex-col gap-[3px]">
                         <div className="text-[13px] font-[600] text-[#111]">Name-{p.name}</div>
                         <div className="text-[13px] font-[600] text-[#111]">Age-{p.age}</div>
                         <div className="text-[13px] font-[600] text-[#111]">Gender-{p.gender}</div>
                         <div className="text-[13px] font-[600] text-[#111]">App.Date-{p.date}</div>
                      </div>

                      {/* Bottom Action Area */}
                      <div className="mt-auto flex h-[40px]">
                         <button 
                            onClick={() => setSelectedPatientForDetails(p)}
                            className="flex-1 bg-[#e8eaeb] hover:bg-[#dde0e1] transition-colors text-[#747474] font-bold text-[13px]"
                         >
                            View Detail
                         </button>
                         <button className={`flex-1 font-bold text-[13px] transition-colors ${btnColorClass}`}>
                            {p.status}
                         </button>
                      </div>
      ...
      {selectedPatientForDetails && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 p-6 backdrop-blur-[1px]" onClick={(e) => { if (e.target === e.currentTarget) setSelectedPatientForDetails(null) }}>
