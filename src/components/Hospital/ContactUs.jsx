      ...
      <div ref={formRef} className="max-w-5xl mx-auto px-4 mt-16 mb-16">
        ...
        <div className="flex mb-6 w-full md:w-[280px]">
          <button
            ...
            className={`flex-1 py-1.5 text-[16px] border-l border-y border-[#A4D7E1] rounded-l-md font-semibold transition-all ${
              activeTab === "feedback"
          ...
          <button
            ...
            className={`flex-1 py-1.5 text-[16px] border border-[#D1D5DB] rounded-r-md font-medium transition-all ${
              activeTab === "queries"
