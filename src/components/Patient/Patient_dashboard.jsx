            ...
            <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
                ...
                <div className="flex-1 px-[20px] md:px-[28px] pb-[60px] w-full max-w-[1440px] mx-auto">
                 ...
                 text-white text-[14px] font-semibold px-[24px] py-[12px] rounded-full shadow-[0_10px_25px_rgba(11,37,61,0.3)] hover:scale-[1.05] transition-all cursor-pointer">
                            ...
                            <div className="relative z-10 hidden sm:flex shrink-0 w-[260px] items-center justify-center mr-[4%]">
                                <div className="w-[240px] h-[240px] bg-[#EEF5F8] rounded-[40px] flex items-center justify-center relative border border-white/50">
                                    <svg className="w-[100px] h-[100px] text-[#86C9D1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>

                                    {/* QR Icon Overlapping Square */}
                                    <div className="absolute bottom-[28px] -right-[12px] w-[86px] h-[86px] bg-white rounded-[28px] shadow-[0_15px_30px_rgba(0,0,0,0.1)] flex items-center justify-center">
                                        <svg className="w-[44px] h-[44px] text-[#175B61]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
