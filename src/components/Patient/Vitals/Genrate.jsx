                ...
                <div className="p-6 space-y-5 bg-white relative z-10 -mt-5 rounded-t-[32px]">
                    ...
                    <div className="space-y-3 pt-1">
                        <button
                            ...
                            className="w-full h-[56px] bg-gradient-to-r from-[#0B1F4D] to-[#1A7785] text-white rounded-full font-bold text-[15px] shadow-xl shadow-teal-900/20 flex items-center justify-center gap-3 transition-all active:scale-95"
                        >
