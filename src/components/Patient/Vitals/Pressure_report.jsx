            ...
            >
                ...
                <div className="flex-1 p-8 bg-white flex flex-col relative items-start">
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full">
                        <button
                            className="h-[56px] bg-[#0B1F4D] text-white rounded-full font-bold text-[14px] flex items-center justify-center gap-2 shadow-lg shadow-blue-900/20 active:scale-95 transition-all"
                        >
                            <Download size={18} />
                            Export PDF
                        </button>
                        <button 
                            onClick={onClose}
                            className="h-[56px] border-2 border-[#F0F4F5] text-[#627382] rounded-full font-bold text-[14px] hover:bg-[#F8FAFB] transition-all active:scale-95"
                        >
                            Close
                        </button>
                    </div>
