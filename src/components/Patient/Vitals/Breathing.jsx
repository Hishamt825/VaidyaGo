                    ...
                    >
                        ...
                        <div className="px-8 pb-8 pt-6 -mt-8 bg-white rounded-t-[40px] relative z-10">
                            ...
                            <div className="bg-[#F3F9FA] border border-[#E5EFF1] rounded-[32px] p-6 mb-6 shadow-inner shadow-teal-900/5">
                                ...
                                <div className="h-[80px] w-full relative overflow-hidden flex items-end">
                                    ...
                                    <svg width="100%" height="100%" viewBox="0 0 400 80" preserveAspectRatio="none" className="overflow-visible">
                                        ...
                                        />
                                        <motion.path
                                            d="M-400 40 Q-350 25 -300 40 T-200 40 T-100 40 T0 40 T100 40 T200 40 T300 40 T400 40"
                                            stroke="#1A7785"
                                            strokeWidth="1.5"
                                            strokeOpacity="0.3"
                                            strokeLinecap="round"
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-8">
                                <motion.div whileHover={{ y: -3 }} className="bg-white border border-[#F0F4F5] rounded-[24px] p-4 flex flex-col items-start shadow-sm transition-all hover:shadow-md">
                                    ...
                                    <div className="w-full h-1 bg-[#F0F4F5] rounded-full overflow-hidden">
                                        <motion.div initial={{ width: 0 }} animate={{ width: "65%" }} transition={{ duration: 1, delay: 0.5 }} className="h-full bg-gradient-to-r from-[#1A7785] to-[#6ED4D4] rounded-full" />
                                    </div>
                                </motion.div>
                                ...
                                <motion.div whileHover={{ y: -3 }} className="bg-white border border-[#F0F4F5] rounded-[24px] p-4 flex flex-col items-start shadow-sm transition-all hover:shadow-md border-l-[3px] border-l-[#1A7785]/30">
                            ...
                            <div className="flex justify-start">
                                <motion.button
                                    whileHover={{ scale: 1.05, backgroundColor: "#06132D" }}
                                    whileTap={{ scale: 0.95 }}
                                    onClick={onClose}
                                    className="bg-[#0B1F4D] text-white px-8 py-3 rounded-full font-bold text-[14px] shadow-lg shadow-blue-900/20 transition-all flex items-center gap-2"
                                >
                                    Done
                                </motion.button>
                            </div>
