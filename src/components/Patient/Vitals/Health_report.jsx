    ...
    return (
        <>
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-8 overflow-y-auto pt-20 pb-20">
                ...
                {/* Report Document */}
                <div
                    className="relative w-full max-w-[850px] bg-white rounded-[32px] shadow-[0_32px_120px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col my-auto border border-white/20 z-[210]"
                >
                    {/* Close Button */}
                    <button 
                        onClick={onClose}
                    ...
                    <div className="bg-[#0D1C2E] p-8 flex items-center justify-between">
                        ...
                        <div className="flex gap-4">
                            <button 
                                ...
                                className="flex items-center gap-2 bg-white/5 border border-white/10 text-white px-5 py-3 rounded-2xl font-bold text-[12px] hover:bg-white/10 transition-all"
                            >
                                <Share2 size={16} />
                                Share
                            </button>
            ...
            {isShareOpen && <Share isOpen={isShareOpen} onClose={() => setIsShareOpen(false)} />}
        </>
    );
};
