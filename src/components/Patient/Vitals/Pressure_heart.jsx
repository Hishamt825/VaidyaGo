            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-[520px] bg-white rounded-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.15)] overflow-hidden"
                    >
                        ...
                        <div className="px-8 pb-6 pt-5 -mt-8 bg-white rounded-t-[40px] relative z-10">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                <motion.div 
                                    whileHover={{ y: -2 }}
                                    className="bg-[#E6F4F1] p-4 rounded-[24px] border border-[#D1E9E4] flex items-center gap-3 transition-all"
                                >
                                ...
                                <motion.div 
                                    whileHover={{ y: -2 }}
                                    className="bg-[#F4F8FA] p-4 rounded-[24px] border border-[#E2EAEE] flex items-center gap-3 transition-all"
                                >
                            ...
                            <div className="flex items-center gap-3 w-full">
                                <motion.button 
                                    ...
                                    className="flex-1 h-[56px] bg-gradient-to-r from-[#0B4052] to-[#1A7785] text-white rounded-[20px] font-bold text-[16px] shadow-xl shadow-teal-900/15 flex items-center justify-center tracking-tight"
                                >
                                    New Measurement
                                </motion.button>
                                <motion.button 
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="w-[110px] h-[56px] rounded-[20px] border-2 border-[#F0F4F5] text-[#627382] font-bold text-[16px] bg-white transition-colors"
                                >
                                    History
                                </motion.button>
                            </div>
