                ...
                <header className="h-[72px] flex items-center justify-between px-6 md:px-10 shrink-0 border-b border-white/5 z-20">
                    ...
                    <div className="flex items-center gap-[16px] ml-auto">
                        <div
                            ...
                            className="text-white/80 hover:text-white text-[12px] font-bold hidden md:block select-none cursor-pointer transition-colors bg-white/10 px-3 py-1 rounded-full border border-white/10 hover:bg-white/20 uppercase tracking-widest"
                        >
