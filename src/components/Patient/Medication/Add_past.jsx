    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center p-4 z-[400]">
            ...
            <div className="bg-white rounded-[32px] w-full max-w-[460px] overflow-hidden shadow-2xl relative z-10 animate-in fade-in zoom-in duration-300">
                ...
                {/* Header */}
                <div className="bg-[#0B1F4D] p-6 pb-4 relative text-white">
                    <h2 className="text-[22px] font-[900] mb-0.5">Add Past Medication</h2>
                    <p className="text-white/70 text-[13px] font-medium">Complete your health history for better insights.</p>
                    <button 
                        onClick={onClose}
                        className="absolute right-5 top-5 p-2 text-white/50 hover:text-white transition-all"
                    >
                ...
                <div className="p-6 space-y-3.5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input 
                                ...
                                className="w-full bg-white border border-gray-100 rounded-[14px] py-3 px-5 text-[14px] text-[#0D1C2E] placeholder-[#627382]/30 outline-none focus:ring-2 focus:ring-[#1A7785]/20 transition-all font-medium shadow-sm"
                            />
                    ...
                    <div className="grid grid-cols-2 gap-3.5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select className="w-full bg-white border border-gray-100 rounded-[14px] py-3 px-5 pr-10 text-[14px] text-[#0D1C2E] appearance-none outline-none focus:ring-2 focus:ring-[#1A7785]/20 transition-all font-medium shadow-sm cursor-pointer">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            <input 
                                ...
                                className="flex-1 bg-white border border-gray-100 rounded-[14px] py-3 px-4 text-[14px] text-[#0D1C2E] placeholder-[#627382]/30 outline-none focus:ring-2 focus:ring-[#1A7785]/20 transition-all font-medium shadow-sm text-center"
                            />
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            className="w-full bg-white border border-gray-100 rounded-[14px] py-3 px-5 text-[14px] text-[#0D1C2E] placeholder-[#627382]/30 outline-none focus:ring-2 focus:ring-[#1A7785]/20 transition-all font-medium shadow-sm min-h-[70px] max-h-[100px] resize-none"
                        ></textarea>
                    </div>
