...
const Profile = ({ onClose, onAccountSettings }) => {
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            {/* Profile Card */}
            <div className="relative w-full max-w-[400px] bg-white rounded-[40px] shadow-[0_25px_80px_rgba(0,0,0,0.4)] overflow-hidden transition-all transform scale-100">
                
                {/* Header with Gradient */}
                <div className="h-[120px] bg-gradient-to-b from-[#0B1F4D] via-[#1a6e78] to-[#49AAB3] relative">
                    {/* Close Button */}
                    <button 
                        onClick={onClose}
                ...
                <div className="flex flex-col items-center -mt-[55px] pb-6 px-6">
                    ...
                    <button className="w-full h-14 bg-gradient-to-r from-[#0B1F4D] via-[#1A7785] to-[#1A7785] rounded-[24px] flex items-center justify-center gap-3 text-white font-medium text-[16px] shadow-[0_12px_30px_rgba(26,119,133,0.3)] hover:opacity-90 transition-all mb-5">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="grid grid-cols-2 gap-3 w-full mb-6">
                        <button 
                            ...
                            className="p-4 bg-[#EAEFF2] rounded-[32px] flex flex-col items-center gap-2 hover:bg-gray-200 transition-all group"
                        >
                            <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center text-[#4B5E7F] shadow-sm group-hover:scale-110 transition-transform">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span className="text-[#0D1C2E] font-medium text-[12px] tracking-tight">Account Settings</span>
                        </button>
                        <button className="p-4 bg-[#EAEFF2] rounded-[32px] flex flex-col items-center gap-2 hover:bg-gray-200 transition-all group">
                            <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center text-[#4B5E7F] shadow-sm group-hover:scale-110 transition-transform">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                </svg>
                            </div>
                            <span className="text-[#0D1C2E] font-medium text-[12px] tracking-tight">Privacy</span>
                        </button>
                    </div>
