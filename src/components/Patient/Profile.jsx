            ...
            <div className="relative w-full max-w-[400px] bg-white rounded-[40px] shadow-[0_25px_80px_rgba(0,0,0,0.4)] overflow-hidden transition-all transform scale-100">
                ...
                <div className="flex flex-col items-center -mt-[55px] pb-6 px-6">
                    ...
                    <button 
                        ...
                        className="w-full h-14 bg-gradient-to-r from-[#0B1F4D] via-[#1A7785] to-[#1A7785] rounded-[24px] flex items-center justify-center gap-3 text-white font-medium text-[16px] shadow-[0_12px_30px_rgba(26,119,133,0.3)] hover:opacity-90 transition-all mb-5"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
